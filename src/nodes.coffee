...
exports.Block = class Block extends Base
  ...
  compileRoot: (o) ->
    ...
    if o.strict
      fragments.unshift @makeCode "#{o.indent}\"use strict\";\n"
...
CALLBACK_NAMES = ['cb', 'callback', 'done', 'next', 'reply', 'replyFn', 'ready', 'readyFn']
...
exports.Code = class Code extends Base
  ...
  compileNode: (o) ->
    ...
    cbname = null
    @eachParamName (name) ->
      cbname = name if name in CALLBACK_NAMES
    ...
    if o.guard and cbname?
      ...
      for guardline in guard_code.split '\n'
        answer.push @makeCode "\n#{o.indent}#{guardline}"
