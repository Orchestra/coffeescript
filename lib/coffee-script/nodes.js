...
(function() {
  "use strict";
  var Access, Arr, Assign, Base, Block, CALLBACK_NAMES, Call, Class, Code, CodeFragment, Comment, Existence, Expansion, Extends, For, GUARD_CODE, HEXNUM, IDENTIFIER, IDENTIFIER_STR, IS_REGEX, IS_STRING, If, In, Index, LEVEL_ACCESS, LEVEL_COND, LEVEL_LIST, LEVEL_OP, LEVEL_PAREN, LEVEL_TOP, Literal, METHOD_DEF, NEGATE, NO, NUMBER, Obj, Op, Param, Parens, RESERVED, Range, Return, SIMPLENUM, STRICT_PROSCRIBED, Scope, Slice, Splat, Switch, TAB, THIS, Throw, Try, UTILITIES, Value, While, YES, addLocationDataFn, compact, del, ends, extend, flatten, fragmentsToText, isLiteralArguments, isLiteralThis, last, locationDataToString, merge, multident, parseNum, some, starts, throwSyntaxError, unfoldSoak, utility, _ref, _ref1,
  ...
  exports.Block = Block = (function(_super) {
    ...
    Block.prototype.compileRoot = function(o) {
      ...
      if (o.strict) {
        fragments.unshift(this.makeCode("" + o.indent + "\"use strict\";\n"));
      }
      if (o.bare) {
        return fragments;
      }
  ...
  exports.Code = Code = (function(_super) {
    ...
    Code.prototype.compileNode = function(o) {
      var answer, boundfunc, cbname, code, exprs, guard_code, guardline, i, lit, p, param, params, ref, splats, uniqs, val, wasEmpty, wrapper, _i, _j, _k, _l, _len, _len1, _len2, _len3, _len4, _len5, _len6, _m, _n, _o, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8;
      ...
      this.eachParamName(function(name) {
        if (__indexOf.call(CALLBACK_NAMES, name) >= 0) {
          return cbname = name;
        }
      });
      _ref3 = this.params;
